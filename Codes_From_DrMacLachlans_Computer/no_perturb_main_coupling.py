...
from no_perturb_coupling import * # changed
from no_perturb_deflated_continuation_code import * # changed
from deflation import *
from equidistribute import *
from no_perturb_solution_discovery_code import * # changed
...
for i in range(len(chosen_sols)):
  ...
  my_plot = 'No_Perturb_May2_Solution_' + str(i+1) + '_at_eps_' + str_eps + '.pdf'
