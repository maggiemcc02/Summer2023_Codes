...
# set the epsilon list 

eps_list = []
eps = eps_0

while eps >= (eps_f - delta_eps):
...
# save the set of solutions 


my_path = '/home/margaretam/github_output/Output_From_MacLachlans_Computer/Continued_Deflation_Codes/output_plots/test1_'
